...
let menu = {
    ...
    items: ['作品一', '作品二', '測驗作品', '作品四', '作品五', '淡江大學'],
    visible: false,
...
// 新增：預載字型
function preload() {
    tkFont = loadFont('fonts/ChironGoRoundTC-SemiBold.ttf');
}
...
const menuUrls = {
    ...
    '作品四': 'https://example.com/works4',
    '作品五': 'https://example.com/works5',
